...
public class CheckFX1 {

    static String pathSrc = "OOP2018";
    static String testee = "TicketCalculator.java";
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (File subdir : subdirs) {
            ...
            if (!subdir.isDirectory()) {
                System.out.println(" --- Skip! NOT directory");
                continue;
            }
            File srcFile = new File(subdir.getPath() + "\\" + testee);
            if (!srcFile.exists()) {
